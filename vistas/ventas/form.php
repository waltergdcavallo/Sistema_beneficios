            ...
            <?php include("../../complementario/encabezado.php") ?>
                ...
                <section class="container">
                    ...
                    <div class="div-form shadow">
                        ...
                        <form action="../../publico/acciones/ventas/editar.php" method="post" class="p-5 row">
                            ...
                            <input type="hidden" name="id_detalle_venta" id="id_detalle_venta" value="<?php echo $fila["id_detalle_venta"];?>">
                                ...
                                <div class="mb-4 col-3">
                                    ...
                                    <input type="text" class="form-control input shadow" id="monto" name="monto" value="<?php echo $fila['monto'];?>">
                                </div>

                                <div class="mb-4 col-3">
                                    <label for="exampleFormControlInput1" class="form-label">Entregado</label>
                                    <select class="form-select input shadow" aria-label="Default select example" id="entregado" name="entregado">
                                ...
                                <div class="mb-4 col-3">
                                    ...
                                    <select class="form-select input shadow" aria-label="Default select example" id="pagado" name="pagado">
                                ...
                                <div class="mb-4 col-5">
                                    ...
                                    <select class="form-select input shadow" aria-label="Default select example" id="id_producto" name="id_producto">
                                ...
                                <div class="mb-4 col-6">
                                    ...
                                    <button type="submit" class="btn button-confirm col-2">Actualizar</button>
...
<?php
            if (isset($_GET["mensaje"])){
                if ($_GET["mensaje"]!="ok"){
                    ...
                    echo "<div class='text-center mt-4 mb-5'><div class='alert alert-success' role='alert'><strong>Venta agregada</strong></div></div>";
                }
            }
